...
// https://github.com/langchain4j/langchain4j/blob/c0e735de3f6a27038dc952ae3604371d25d67a08/langchain4j-mcp/src/main/java/dev/langchain4j/mcp/client/ToolSpecificationHelper.java
class ToolSpecificationHelper {
    ...
    static JsonSchemaElement jsonNodeToJsonSchemaElement(JsonNode node) {
        ...
        if (nodeType.equals("object")) {
            ...
            return builder.build();
        } else if (nodeType.equals("boolean") || nodeType.equals("bool")) {
